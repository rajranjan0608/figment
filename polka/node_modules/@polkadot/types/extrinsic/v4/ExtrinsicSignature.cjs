...
class GenericExtrinsicSignatureV4 extends _Struct.Struct {
  ...
  sign(method, account, options) {
    (0, _util.assert)(account && account.addressRaw, `Expected a valid keypair for signing, found ${JSON.stringify(account)}`);
  ...
  signFake(method, address, options) {
    (0, _util.assert)(address, `Expected a valid address for signing, found ${JSON.stringify(address)}`);
