...
var _assertVersion = (0, _classPrivateFieldLooseKey2.default)("assertVersion");

var _getVersion = (0, _classPrivateFieldLooseKey2.default)("getVersion");

var _metadata = (0, _classPrivateFieldLooseKey2.default)("metadata");
...
class MetadataVersioned extends _codec.Struct {
  constructor(registry, value) {
    ...
    Object.defineProperty(this, _getVersion, {
      ...
      value: (version, fromPrev) => {
        ...
        if ((0, _classPrivateFieldLooseBase2.default)(this, _assertVersion)[_assertVersion](version)) {
  ...
  get asLatest() {
    ...
    return (0, _classPrivateFieldLooseBase2.default)(this, _getVersion)[_getVersion](13, _toLatest.toLatest);
  }
  /**
   * @description
   */
